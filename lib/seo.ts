...
export const jsonLdSchema = {
  ...
  "@type": "LocalBusiness",
  "name": "OnGrid Solar",
  "description": "Leading Solar Panel Installation company in Trivandrum, Kerala. Expert Rooftop Solar Systems, Commercial Solar Power Solutions, Solar Battery Storage & Hybrid Systems.",
  ...
  "sameAs": [
    "https://ongridsolarpowersolution.com"
  ],
  "hasCredential": {
  ...
  "makesOffer": [
    {
      ...
      "itemOffered": {
        ...
        "description": "Professional solar panel installation services for residential and commercial properties in Trivandrum"
      }
    },
    {
      "@type": "Offer", 
      "itemOffered": {
        ...
        "description": "Complete rooftop solar system design and installation with government subsidy up to ₹78,000"
      }
    },
    {
      "@type": "Offer",
      "itemOffered": {
        ...
        "description": "Large-scale commercial solar power solutions for businesses and industries"
      }
    }
  ]
};
